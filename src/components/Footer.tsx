    ...
    <footer className="bg-secondary text-secondary-foreground py-12 border-t-4 border-primary">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">डॉ. मो. शहाब उद्दीन</h3>
            <p className="text-secondary-foreground/80 mb-2">जन सुराज पार्टी के प्रत्याशी</p>
            <p className="text-lg font-semibold">232 बेलागंज विधानसभा</p>
          </div>

          <div>
            <h4 className="text-xl font-bold mb-4">त्वरित लिंक</h4>
            <ul className="space-y-2">
              ...
              <li>
                <a href="#career" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors">
                  व्यावसायिक यात्रा
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-secondary-foreground/80 mb-2">फोन: 6287892656</p>
            <p className="text-secondary-foreground/80">लक्ष्मीपुर, बेलागंज, गया, बिहार</p>
          </div>
        </div>
